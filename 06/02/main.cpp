...
int main(){
	...
	output.append(1, findMin(char0));
	output.append(1, findMin(char1));
	output.append(1, findMin(char2));
	output.append(1, findMin(char3));
	output.append(1, findMin(char4));
	output.append(1, findMin(char5));
	output.append(1, findMin(char6));
	output.append(1, findMin(char7));
